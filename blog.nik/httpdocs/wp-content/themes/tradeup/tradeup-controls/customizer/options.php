...
if( ! empty( $tradeup_cs_no_filters ) ) {
	foreach( $tradeup_cs_no_filters as $bcnf => $bcnf_value ) {
		$tradeup_customizer_settings[$bcnf] = apply_filters( 'tradeup_' . $bcnf . '_filter', $bcnf_value );
	}
}
