 ...
 */
if( ! class_exists( 'Tradeup_Control_RGBA' ) ) {
	class Tradeup_Control_RGBA extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script(
				'rgba-picker',
				get_template_directory_uri() . '/tradeup-controls/customizer/controls/rgba/rgba-picker.js',
			...
			wp_enqueue_style(
				'rgba-picker',
				get_template_directory_uri() . '/tradeup-controls/customizer/controls/rgba/rgba-picker.css',
