...
abstract class THWVSF_Admin_Settings {
	...
	public function __construct($page, $section = '') {
		...
		$this->tabs = array( 
			...
			'global_product_attributes' => __('Product Attributes', 'product-variation-swatches-for-woocommerce'),
			'swatches_design_settings'  => __('Swatches Designs','product-variation-swatches-for-woocommerce'),
			'general_settings'          => __('Global Settings','product-variation-swatches-for-woocommerce')
	...
	public function output_premium_version_notice(){
        ...
        $is_dismissed = get_transient('thwvsf_upgrade_notice_dismissed');
		if($is_dismissed){
			return;
		}
		?>
        <div id="message" class="thwvsf-notice thwvsf-free-banner thwvsf-notice notice notice-success is-dismissible">
            <div class="squeezer">
               
                <div class="thwvsf-image-wrapper " > 
        			</button>
                	<a target="_blank" href="https://www.themehigh.com/product/woocommerce-product-variation-swatches" class="">
                		<img src="<?php echo THWVSF_ASSETS_URL_ADMIN.'images/upgrade-banner.png';?>" alt="themehigh"/>
                	</a>
                </div>
            </div>
        </div>
