			...
			<div class="thwvsf_settings">
		        ...
		        <div id="thwvsf_global_settings"  style="display: inherit;" class="global-data-content" >
	                ...
	                <div class="btn-toolbar">
						...
						<input type="submit" class="reset-btn btn-primary-alt" name="global_reset_settings" class="button-primary" value="<?php _e('Reset', 'woocommerce-product-variation-swatches'); ?>">	
