...
Tags: Variation swatches, product attributes, color swatches, woocommerce variation swatches, WooCommerce Variation, Woocommerce attributes
...
WooCommerce Variation Swatches lets you add variation swatches for variable product attributes in your WooCommerce online store.
...
You can create swatches of 3 types to display the product attributes, namely color, image, and label with an option to display in square or circle icon. Also show the attribute’s term name as a tooltip when someone hovers over a swatch.

The smooth transition and look of swatches will give you an added advantage in achieving your sales goals.

>[Try the Demo](https://flydemos.com/wpvs/) | [Documents](https://help.themehigh.com/hc/en-us/categories/900000374206-Variation-Swatches-For-WooCommerce-) | [Pro Version](https://www.themehigh.com/product/woocommerce-product-variation-swatches/)
...
= ☞ 3 Swatch Types =
You can create swatches of 3 types, namely **image, color, and label** for your variable product attributes.
...
Set the unavailable and out-of-stock variant’s swatches with three custom options - **hide, blur, or blur with a cross**.
...
= ☞ Customize Swatches =
You can choose between square or round icons for your product variation swatches and define the icons’ height & width. Apart from these customizations, you will be able to set font size, font color, and background color, as well as the icon width and height for label swatches exclusively.
...
With the premium version of the plugin, you can display the swatches in the additional information part of the product.
...
With our <a href="https://www.themehigh.com/product/woocommerce-product-variation-swatches/?utm_source=wordpress&utm_medium=referral&utm_content=tracking">Premium version</a>, you can set swatches for local attributes. Once installed, you can configure the same from the Product page.
...
2. Image swatch preview
3. Label swatch preview
4. Behaviour for unavailable and out of stock variation
5. Term name tooltip preview
6. Swatches Design types
7. Attribute styling
8. Swatch type styling
9. Tooltip styling
10. Hover and Border styling
11. Global settings
12. Global color variation attribute list preview
13. Global image variation attribute list preview
...
* Added Compatibility with bundeled product plugin By WPclever.net.
